...
//+
// Transfinite Curve {3, 4, 1, 2} = 5 Using Progression 1;
// //+
// Transfinite Curve {6, 7, 8, 5} = 3 Using Progression 1;
//+
Transfinite Curve {3, 4, 1, 2} = 121 Using Progression 1;
//+
Transfinite Curve {6, 7, 8, 5} = 101 Using Progression 1;
//+
Recombine Surface {2};
