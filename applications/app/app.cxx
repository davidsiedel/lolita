...
int main(int argc, char** argv)
{
    ...
    auto msh = lolita2::geometry::MeshParser<lolita2::MeshData::Gmsh, domain>::makeMesh(file_path);
    ...
    auto faces_unknowns = msh.template make<1, lolita2::geometry::FiniteElementUnknown, field, basis>("SQUARE", faces_unknown);
