...
MicromorphicDamageIIParametersInitializer::get()
{
static MicromorphicDamageIIParametersInitializer i;
return i;
}

MicromorphicDamageIIParametersInitializer::MicromorphicDamageIIParametersInitializer()
{
this->minimal_time_step_scaling_factor = 0.1;
this->maximal_time_step_scaling_factor = 1.7976931348623e+308;
// Reading parameters from a file
MicromorphicDamageIIParametersInitializer::readParameters(*this,"MicromorphicDamageII-parameters.txt");
}

void
MicromorphicDamageIIParametersInitializer::set(const char* const key,
const double v){
using namespace std;
...
tfel::raise("MicromorphicDamageIIParametersInitializer::set: "
" no parameter named '"+std::string(key)+"'");
}
}

double
MicromorphicDamageIIParametersInitializer::getDouble(const std::string& n,
const std::string& v)
{
double value;
...
"MicromorphicDamageIIParametersInitializer::getDouble: "
"can't convert '"+v+"' to double for parameter '"+ n+"'");
return value;
}

void
MicromorphicDamageIIParametersInitializer::readParameters(MicromorphicDamageIIParametersInitializer& pi,const char* const fn){
...
tfel::raise_if(c,"MicromorphicDamageIIParametersInitializer::readParameters: "
...
pi.minimal_time_step_scaling_factor = MicromorphicDamageIIParametersInitializer::getDouble(tokens[0],tokens[1]);
} else if("maximal_time_step_scaling_factor"==tokens[0]){
pi.maximal_time_step_scaling_factor = MicromorphicDamageIIParametersInitializer::getDouble(tokens[0],tokens[1]);
} else {
