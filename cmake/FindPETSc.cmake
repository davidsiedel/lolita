...
if(EXISTS "${PETSC_DIR}/lib/libpetsc.so")
  set(PETSC_LIB "${PETSC_DIR}/lib/libpetsc.so")
elseif(EXISTS "${PETSC_DIR}/lib/libpetsc.a")
  set(PETSC_LIB "${PETSC_DIR}/lib/libpetsc.a")
elseif(EXISTS "${PETSC_DIR}/lib/libpetsc.dylib")
  set(PETSC_LIB "${PETSC_DIR}/lib/libpetsc.dylib")
else()
...
## MUMPS ##
###########
if(EXISTS ${PETSC_DIR}/lib/libmumps_common.a)
  set(PETSC_MUMPS TRUE)
  set(PETSC_MUMPS_INC ${PETSC_INC})
  set(PETSC_MUMPS_LIB
    ${PETSC_DIR}/lib/libcmumps.a
    ${PETSC_DIR}/lib/libdmumps.a
    ${PETSC_DIR}/lib/libsmumps.a
    ${PETSC_DIR}/lib/libzmumps.a
    ${PETSC_DIR}/lib/libmumps_common.a
    ${PETSC_DIR}/lib/libpord.a)

  if(EXISTS ${PETSC_DIR}/lib/libmpiseq.a)
    set(PETSC_MUMPS_SEQ ${PETSC_DIR}/lib/libmpiseq.a)
  else()
    set(PETSC_MUMPS_SEQ "")
  endif()
...
## ScaLAPACK ##
###############
if(EXISTS ${PETSC_DIR}/lib/libscalapack.a)
  set(PETSC_SCALAPACK TRUE)
  set(PETSC_SCALAPACK_LIB ${PETSC_DIR}/lib/libscalapack.a)
else()
...
## ParMETIS ##
##############
if(EXISTS ${PETSC_DIR}/lib/libparmetis.so)
  set(PETSC_PARMETIS TRUE)
  set(PETSC_PARMETIS_LIB ${PETSC_DIR}/lib/libparmetis.so)
elseif(EXISTS ${PETSC_DIR}/lib/libparmetis.dylib)
  set(PETSC_PARMETIS TRUE)
  set(PETSC_PARMETIS_LIB ${PETSC_DIR}/lib/libparmetis.dylib)
else()
...
## METIS ##
############
if(EXISTS ${PETSC_DIR}/lib/libmetis.so)
  set(PETSC_METIS TRUE)
  set(PETSC_METIS_LIB ${PETSC_DIR}/lib/libmetis.so)
elseif(EXISTS ${PETSC_DIR}/lib/libmetis.dylib)
  set(PETSC_METIS TRUE)
  set(PETSC_METIS_LIB ${PETSC_DIR}/lib/libmetis.dylib)
else()
