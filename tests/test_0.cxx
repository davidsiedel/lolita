...
TEST(t0, t0)
{
    ...
    auto constexpr field = lolita2::Field(1);
    auto constexpr basis = lolita2::Basis(lolita2::Basis::Monomial, 1);

    // auto lmp = lolita2::Discretization::HJKL(lolita2::Quadrature(lolita2::Quadrature::Gauss, 2), 2);


    auto constexpr u1 = lolita2::Unknown(lolita2::Field(0), lolita2::Mapping(lolita2::Mapping::Gradient));
    auto constexpr u2 = lolita2::Unknown(lolita2::Field(1), lolita2::Mapping(lolita2::Mapping::Gradient), lolita2::Mapping(lolita2::Mapping::Identity));
    ...
    std::cout << "ici fld size : " << lolita2::geometry::FieldTraits<domain, field>::size_ << std::endl;
