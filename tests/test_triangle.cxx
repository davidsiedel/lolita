...
TEST(test_triangle, test_triangle)
{
    ...
    // node 0
    node_0->coordinates_ = std::make_shared<lolita::Point>(lolita::Point({0., 0., 0.}));
    // node 1
    node_1->coordinates_ = std::make_shared<lolita::Point>(lolita::Point({1., 0., 0.}));
    // node 2
    node_2->coordinates_ = std::make_shared<lolita::Point>(lolita::Point({0., 1., 0.}));
    // segment 0 / nodes
