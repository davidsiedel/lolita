...
namespace lolita::geometry
{
    ...
    template<ShapeConcept Shape_, template<typename, typename...> typename T_ = TypeView, typename... U_>
    ...
    struct ShapeInnerNeighborhood
    {
        ...
        getNumComponents()
        {
            return std::tuple_size_v<std::tuple_element_t<getShapeIndex<Neighbor_>(1), std::tuple_element_t<getShapeIndex<Neighbor_>(0), Components>>>;
        }
    ...
    template<ShapeConcept Shape_, FrameConcept Frame_, template<typename, typename...> typename T_ = TypeView, typename... U_>
    requires(!CellConcept<Frame_, Shape_>)
