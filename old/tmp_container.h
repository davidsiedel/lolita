...
//        {
//
//            lolita::index const static constexpr name_size = 150;
//
//        }
//
//        template<typename T>
...
//        using Label = Labell<lolita::character>;
//
//        lolita::index const static constexpr label_size = 150;
//
//        using label = std::array<lolita::character, label_size>;
